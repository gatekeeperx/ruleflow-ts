...
const cases = [
  ...
  RULESET 'CHILE' merchant.countryIsoCode = 'CL' THEN
    'CL_B_CANCEL_INTERNATIONAL_BIN' paymentMethod.country NOT IN 'CL' AND ((merchant.merchantId NOT IN list('GL_ALL_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_SOUTH_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_SOUTH_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_NORTH_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_NORTH_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_CENTRAL_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_CENTRAL_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_EUROPE_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_EUROPE_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_ASIA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_ASIA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_OCEANIA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_OCEANIA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_AFRICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_AFRICA_BIN_ALLOWED_MIDS'))) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'CL_B_CANCEL_MAX_AMOUNT' transaction.amount.amount > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D)*5) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'CL_B_CANCEL_LIMITS_AMOUNT' features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_24h > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D*120))*5) OR (features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_30D > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D*4))*5)) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'CL_B_CANCEL_LIMITS_QTY' features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_24h > ((features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_CARDID_PER_COUNTRY_MCC_APPROVAL_120D*120))*2.5) OR (features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_30D > ((features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_CARDID_PER_COUNTRY_MCC_APPROVAL_120D*4))*2.5)) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
  RULESET 'ECUADOR' merchant.countryIsoCode = 'EC' THEN
    'EC_B_CANCEL_INTERNATIONAL_BIN' paymentMethod.country NOT IN 'EC' AND ((merchant.merchantId NOT IN list('GL_ALL_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_SOUTH_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_SOUTH_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_NORTH_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_NORTH_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_CENTRAL_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_CENTRAL_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_EUROPE_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_EUROPE_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_ASIA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_ASIA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_OCEANIA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_OCEANIA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_AFRICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_AFRICA_BIN_ALLOWED_MIDS'))) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'EC_B_CANCEL_MAX_AMOUNT' transaction.amount.amount > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D)*5) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'EC_B_CANCEL_LIMITS_AMOUNT' features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_24h > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D*120))*5) OR (features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_30D > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D*4))*5)) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'EC_B_CANCEL_LIMITS_QTY' features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_24h > ((features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_CARDID_PER_COUNTRY_MCC_APPROVAL_120D*120))*2.5) OR (features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_30D > ((features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_CARDID_PER_COUNTRY_MCC_APPROVAL_120D*4))*2.5)) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'EC_CANCEL_CLARO_BLACKLIST' merchant.merchantId = '10123114697881639736151759761218' AND (paymentMethod.paymentMethodId IN list('EC_CLARO_CARDID_BLACKLIST') OR customer.phoneNumber IN list('EC_CLARO_PHONE_BLACKLIST')) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K322'})
    'EC_CANCEL_CLARO_MAX_AMOUNT' merchant.merchantId = '10123114697881639736151759761218' AND transaction.amount.amount > 31 RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K322'})
    'EC_CANCEL_CLARO_MIN_AMOUNT' merchant.merchantId = '10123114697881639736151759761218' AND transaction.amount.amount = 0 RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K322'})
    'EC_CANCEL_CLARO_LIMITS_AMOUNT' merchant.merchantId = '10123114697881639736151759761218' AND (features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_24h > 20 OR features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_30D > 45 OR (features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_24h > 30 AND paymentMethods.cardBin IN list('EC_CLARO_HIGH_RISK_BINS')) OR (features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_24h > 45 AND paymentMethod.cardBin = '514440') OR (features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_14D > 30 AND paymentMethod.cardBin = '416683') OR (features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_14D > 60 AND paymentMethods.cardBin IN list('EC_CLARO_HIGH_RISK_BINS')) OR (features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_7D > 65 AND paymentMethod.cardBin <> '514440')) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K322'}) AND action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K322'})
    ...
    'EC_CANCEL_CLARO_HIGH_RISK_BIN' merchant.merchantId = '10123114697881639736151759761218' AND paymentMethod.cardBin IN list('EC_CLARO_HIGH_RISK_BIN') RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K322'})
    'EC_CANCEL_CLARO_PAYMENT_BRAND_ALIA' merchant.merchantId = '10123114697881639736151759761218' AND paymentMethod.cardBin IN list('EC_PAYMENT_BRAND_ALIA_BIN') AND (features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_24h > 1 OR features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_7D > 3 OR features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_14D > 5 OR features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_24h > 10) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K322'})
  RULESET 'COLOMBIA' merchant.countryIsoCode = 'CO' THEN
    'CO_B_CANCEL_INTERNATIONAL_BIN' paymentMethod.country NOT IN 'CO' AND ((merchant.merchantId NOT IN list('GL_ALL_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_SOUTH_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_SOUTH_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_NORTH_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_NORTH_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_CENTRAL_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_CENTRAL_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_EUROPE_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_EUROPE_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_ASIA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_ASIA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_OCEANIA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_OCEANIA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_AFRICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_AFRICA_BIN_ALLOWED_MIDS'))) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'CO_B_CANCEL_MAX_AMOUNT' transaction.amount.amount > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D)*5) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'CO_B_CANCEL_LIMITS_AMOUNT' features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_24h > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D*120))*5) OR (features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_30D > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D*4))*5)) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'CO_B_CANCEL_LIMITS_QTY' features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_24h > ((features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_CARDID_PER_COUNTRY_MCC_APPROVAL_120D*120))*2.5) OR (features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_30D > ((features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_CARDID_PER_COUNTRY_MCC_APPROVAL_120D*4))*2.5)) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
  RULESET 'PERU' merchant.countryIsoCode = 'PE' THEN
    'PE_B_CANCEL_INTERNATIONAL_BIN' paymentMethod.country NOT IN 'PE' AND ((merchant.merchantId NOT IN list('GL_ALL_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_SOUTH_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_SOUTH_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_NORTH_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_NORTH_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_CENTRAL_AMERICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_CENTRAL_AMERICA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_EUROPE_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_EUROPE_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_ASIA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_ASIA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_OCEANIA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_OCEANIA_BIN_ALLOWED_MIDS')) OR (paymentMethod.country IN list('GL_AFRICA_BIN_ISO_CODE') AND merchant.merchantId NOT IN list('GL_AFRICA_BIN_ALLOWED_MIDS'))) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'PE_B_CANCEL_MAX_AMOUNT' transaction.amount.amount > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D)*5) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'PE_B_CANCEL_LIMITS_AMOUNT' features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_24h > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D*120))*5) OR (features.SUM_AMOUNT_PER_CARDID_MID_APPROVAL_30D > ((features.SUM_AMOUNT_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D*4))*5)) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
    'PE_B_CANCEL_LIMITS_QTY' features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_24h > ((features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_CARDID_PER_COUNTRY_MCC_APPROVAL_120D*120))*2.5) OR (features.QTY_TRANSACTIONS_PER_CARDID_MID_APPROVAL_30D > ((features.QTY_TRANSACTIONS_PER_COUNTRY_MCC_APPROVAL_120D/(features.QTY_CARDID_PER_COUNTRY_MCC_APPROVAL_120D*4))*2.5)) RETURN block WITH action('add_tag', {'entity':'transaction','entityId':transaction.transactionId,'tag':'K350'})
 DEFAULT ok   
END`,
    data: {},
    lists: {},
