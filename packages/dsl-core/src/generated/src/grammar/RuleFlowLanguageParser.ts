			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.state = 270;
						(_localctx as MathMulContext)._right = this.expr(21);
						}
						break;
					...
					case 2:
						...
						this.state = 273;
						(_localctx as MathAddContext)._right = this.expr(20);
						}
						break;
					...
					case 3:
						...
						this.state = 276;
						(_localctx as ComparatorContext)._right = this.expr(19);
						}
						break;
